...
var Essential_Audio = (() => {
  ...
  function Ba(a) {
    a.zn = t;
    h = k;
    j = h - (a.za.getBoundingClientRect().left + window.scrollX);
    if (!l) {
  ...
  function Bb(a) {
    if (a.zd > 0) {
      ...
      function Bf() {
        o = t;
        a.za.classList.add("drag");
        p = k - a.za.parentNode.getBoundingClientRect().left - j;
        a.zf = Math.min(Math.max(p, 0), a.zd);
        a.za.style.left = a.zf + "px";
        if (a.zp && a.zl) {
          V(a);
      ...
      function Bg() {
        ...
        if (o) {
          ...
          q = k - a.za.parentNode.getBoundingClientRect().left - j;
          a.zf = Math.min(Math.max(q, 0), a.zd);
          a.za.style.left = a.zf + "px";
          if (pl(a)) {
            V(a);
            if (a.zl) {
  ...
  function U(a) {
    if (pl(a)) {
      ...
      a.zg = pp((vi / pl(a)) * 100);
      if (a.za.parentNode.parentNode != n) {
